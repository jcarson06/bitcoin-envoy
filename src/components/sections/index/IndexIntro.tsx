...
const IndexIntro = memo(() => {
  ...
  return <section 
    className="overflow-hidden relative bg-cover py-20 md:py-32" 
    id="hero" 
    style={{
    ...
    <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
        <div className="w-full lg:w-1/2">
          ...
          <p className="section-subtitle mt-3 sm:mt-6 mb-4 sm:mb-8 leading-relaxed animate-fade-in stagger-2 text-gray-950 font-normal text-base sm:text-lg text-left">

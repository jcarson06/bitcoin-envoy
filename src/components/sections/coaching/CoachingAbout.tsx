        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">Jeff is a former U.S. Army Captain and Iraq War veteran with an MBA and two decades of experience across business, tech, and public policy. He’s lived abroad, traveled to 70+ countries, and seen firsthand the real-world costs of broken money — first in Zimbabwe and later in Argentina — experiences that led him to Bitcoin as a practical solution. Today, he works as a Bitcoin coach and educator, helping everyday people understand, buy, and safely hold Bitcoin to protect their savings and gain financial independence.</p>
            </div>

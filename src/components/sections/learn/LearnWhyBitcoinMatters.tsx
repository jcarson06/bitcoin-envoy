      ...
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">An excellent introduction to the many use cases of Bitcoin and how it's changing the world for the better. This is hands down the best 20 minutes you'll spend learning about Bitcoin. Attribution: Bitcoin Policy Institute</p>
          </div>
        </div>
      </div>
    </Section>;

...
const IndexWhyBitcoin = () => {
  ...
  return <Section spacing="lg" background="white" id="why-humanoid">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {cards.map((card, index) => <div key={index} className="relative overflow-hidden rounded-2xl shadow-xl opacity-0 animate-fade-in hover:scale-105 transition-transform duration-300" style={{
          height: '400px',
            ...
            backgroundBlendMode: "overlay"
              ...
              <div className="relative z-10 p-6 md:p-8 h-full flex items-end">
                <div className="max-w-lg">
                  <h3 className="text-xl sm:text-2xl font-display text-white font-bold leading-tight md:text-4xl">
                    {card.title}
                  </h3>
                </div>
              </div>

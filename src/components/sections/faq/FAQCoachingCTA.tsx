...
const FAQCoachingCTA = () => {
  return <Section id="faq-coaching-cta" spacing="lg" background="gray">
      <div className="section-container text-center">
        ...
        <p className="section-subtitle mb-8 max-w-2xl mx-auto">Learn more about perso one-on-one coaching with real human bitcoin experts. There's no obligation, and your first session is 100% free.</p>

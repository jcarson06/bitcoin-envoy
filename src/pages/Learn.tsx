      ...
      <Section id="why-bitcoin-has-value" spacing="lg" background="gray">
        <div className="section-container">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle mx-auto max-w-2xl">Now that you understand what Bitcoin is and how traditional money loses value, let's explore what gives Bitcoin its value and why more and more people are adopting it everyday. [3 min]</p>
          </div>
